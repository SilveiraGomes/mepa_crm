...
// P0.3.2: person_employment; source: approved model_catalog / dictionary.
...
CREATE TABLE `person_employment` (
  ...
  `profession` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
SQL
    ...
    {
        DB::statement('DROP TABLE `person_employment`');
    }
};
