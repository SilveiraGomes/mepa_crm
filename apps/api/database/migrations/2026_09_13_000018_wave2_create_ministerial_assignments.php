...
// P0.3.2: ministerial_assignments; source: approved model_catalog / dictionary.
...
CREATE TABLE `ministerial_assignments` (
  ...
  CONSTRAINT `ck_ministerial_assignments_appointment_kind` CHECK (`appointment_kind` IN ('SUBSTANTIVE','INTERIM'))
...
SQL
    ...
    {
        DB::statement('DROP TABLE `ministerial_assignments`');
    }
};
